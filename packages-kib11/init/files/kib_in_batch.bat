...
echo.
echo Welcome to KIB in Batch 11.0.13 ^(%PROCESSOR_ARCHITECTURE%^)
echo Booting system...
echo ------------------------------------------------
...
(
    ...
    echo VERSION="11.0.13"
    echo ID=kibbatch
    echo ID_LIKE=linux
    echo VERSION_ID="11.0.13"
    echo PRETTY_NAME="KIB in Batch 11.0.13"
...
echo 11.0.13>"%APPDATA%\kib_in_batch\VERSION.txt"
