...
echo.
echo Welcome to KIB in Batch 11.0.8 ^(%PROCESSOR_ARCHITECTURE%^)
echo Booting system...
echo ------------------------------------------------
...
(
    ...
    echo ID=kibbatch
    echo ID_LIKE=linux
    echo VERSION_ID="11.0.8"
    echo PRETTY_NAME="KIB in Batch 11.0.8"
...
echo 11.0.8>"%APPDATA%\kib_in_batch\VERSION.txt"
